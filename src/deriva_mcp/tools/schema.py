...
def register_schema_tools(mcp: FastMCP, conn_manager: ConnectionManager) -> None:
    ...
    async def set_table_display_name(table_name: str, display_name: str) -> str:
        ...
        This is a convenience tool for setting just the display name. For setting
        multiple display properties at once (name, markdown_name, etc.), use
        set_display_annotation instead.
    ...
    async def set_column_display_name(
        ...
        This is a convenience tool for setting just the display name. For setting
        multiple display properties at once (name, markdown_name, etc.), use
        set_display_annotation with a column_name parameter instead.
